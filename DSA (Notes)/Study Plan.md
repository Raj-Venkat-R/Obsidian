...
> Goal: Master core concepts first → apply them to LeetCode problems later

---

## 🟢 PHASE 0: Absolute Foundations (Must Know)
...
## 🟢 PHASE 1: Arrays (THE BASE OF EVERYTHING)
...
## 🟢 PHASE 2: Strings (Array of Characters)
- [x] How strings are stored
- [x] String immutability (important!)
...
## 🟢 PHASE 3: Sorting Algorithms (FOUNDATIONAL)
...
## 🟢 PHASE 5: Two Pointers Technique
...
## 🟢 PHASE 6: Sliding Window Technique
...
## 🟢 PHASE 7: Hashing / Frequency (CORE OPTIMIZATION TOOL)
...
## 🟢 PHASE 9: Recursion (Core Thinking Skill)
...
## 🟢 PHASE 10: Backtracking (State Space Search)
...
---
## 🟢 PHASE 15: Binary Search Tree (BST)
- [ ] BST property
- [ ] Why BST is powerful
...
## 🟢 PHASE 16: Heap / Priority Queue
- [ ] What heap guarantees (and what it doesn’t)
...
## 🟢 PHASE 18: Segment Tree (ADVANCED RANGE QUERIES)
...
## 🟢 PHASE 20: Dynamic Programming (LAST & HEAVY)
- [ ] Why DP exists
...
## 🟢 PHASE 21: Bit Manipulation (Optional but Powerful)
